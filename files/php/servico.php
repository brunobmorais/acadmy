...
$sql = "SELECT DISTINCT(S.CODSERVICO), S.NOME, S.PASTA FROM SIS_PRIVILEGIO AS P 
...
AND A.CODUSUARIO=".$codUsuarioSessao." AND M.CODMODULO=".$moduloCodModulo."
ORDER BY S.ORDEM, S.NOME";


$rsBuscaServicos = $banco->executeQuery($sql);?>

<div class="main-content">
    <section class="section">
        <?include($raiz . "files/php/titulopagina.php");?>
        <div class="col-md-12 p-0">
            <? foreach ($banco->pegarCampos($rsBuscaServicos) as $dados) {$cont++?>
